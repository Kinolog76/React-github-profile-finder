    ...
    <>
      ...
      <div className="mx-auto flex justify-center gap-3 my-6">
        <input
          ...
          className="px-2 rounded-lg text-lg text-black"
        />
        <button
          onClick={findProfile}
          className="bg-green-700 font-semibold rounded-md px-2 text-lg hover:bg-green-500 disabled:bg-gray-600"
          disabled={containsCyrillic(userName)}>
          ...
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="block md:hidden w-6 h-6 mx-2 my-2">
            <path
              strokeLinecap="round"
      ...
      {!userData || userData === 404 ? (
        <h2 className="text-center font-bold text-2xl mt-3">
          {containsCyrillic(userName) ? "Constain cyrrilic symbol" : "User not found"}
        </h2>
      ) : (
        <>
          <h2 className="text-center font-bold text-2xl mt-3 mb-3">
            {containsCyrillic(userName) && "Constain cyrrilic symbol"}
          </h2>
          <div className="flex w-fit flex-col items-center border border-gray-300 rounded-lg p-3">
            ...
            <a
              ...
              target="_blank"
              className="text-2xl font-bold underline hover:text-gray-300">
              {userData.login}
            </a>
